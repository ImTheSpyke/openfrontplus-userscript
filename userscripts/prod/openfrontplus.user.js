...
(async function() {
   ...
   function launchHoverMenu() {
       ...
       document.addEventListener("mousemove", (event) => {
           ...
           console.log("noMovedFor:",notMovedFor())
       })
       function notMovedFor() { return Date.now() - not_moved_since }
       setInterval(() => {
           if(notMovedFor() < 250) {
               document.querySelector("player-info-overlay").setAttribute("style","display:none;")
               return
           }
           document.querySelector("player-info-overlay").setAttribute("style","display:inherit;")
    ...
    class OpenfrontPlus {
        ...
        hydrogenBomb(tile, text="") {
            ...
            window.OpenFrontPlus_overlay.addDraw({
                ...
                borderColor: 'rgba(255, 81, 81, 0.0)',
                borderWidth: 0,
                decay: [3, 25], // keep 2s, fade 1.5s
                text: "",
                textColor:'white',
        ...
        atomBomb(tile, text="") {
            ...
            window.OpenFrontPlus_overlay.addDraw({
                ...
                borderColor: 'rgba(255, 143, 69, 0.0)',
                borderWidth: 0,
                decay: [3, 25], // keep 2s, fade 1.5s
                text: "",
                textColor:'white',
